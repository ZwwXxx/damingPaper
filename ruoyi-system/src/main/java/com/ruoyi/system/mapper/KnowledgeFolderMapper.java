...
public interface KnowledgeFolderMapper 
{
     ...
     * @return 默认收藏夹
     */
    public KnowledgeFolder selectDefaultFolderByUserId(Long userId);
     ...
     * @param count 数量增减值（正数增加，负数减少）
     * @return 结果
     */
    public int updateFolderCollectCount(@Param("folderId") Long folderId, @Param("count") int count);
}
