<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="操作平台" prop="logType">
         <el-select
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-tag v-if="scope.row.logType === '0'" type="info" size="small">后台</el-tag>
          <el-tag v-else-if="scope.row.logType === '1'" type="success" size="small">前台</el-tag>
          <span v-else></span>
        </template>
      </el-table-column>
    </el-table>
